...
MongoDB, um banco de dados NoSQL, é conhecido por seu alto desempenho e escalabilidade. Ele é ideal para lidar com altos volumes de dados na ZynxAPI.
...
**Flush e Stop**: Limpa todos os logs do PM2, útil para solução de problemas após a atualização e para parar temporariamente a Zynx API para aplicar atualizações com segurança.
...
**Diretório da Zynx API**: acesse o diretório de instalação com o seguinte comando:
~~~
cd evolution-api
~~~
