...
Para utilizar efetivamente o **RabbitMQ** com a **Zynx API** para gerenciar instâncias do WhatsApp, é essencial **ativar o RabbitMQ** em cada **instância individual** do WhatsApp. <br/>
...
Para configurar o RabbitMQ para instâncias individuais do WhatsApp na Zynx API, você pode usar o seguinte endpoint:
