...
MongoDB, a NoSQL database, is known for high performance and scalability. It's ideal for handling large data volumes in the Zynx API.
...
**Flush and Stop**: Clears all logs from PM2, useful for troubleshooting after the update and temporarily stops the Zynx API to safely apply updates.
...
**Zynx API directory**: access your directory installation with the following command:
~~~
cd evolution-api
~~~
