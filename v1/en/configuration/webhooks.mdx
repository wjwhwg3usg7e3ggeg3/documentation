...
Webhooks enable real-time integration between the Zynx API and WhatsApp™, allowing automated data synchronization and sharing.
...
### Example
 ...
 Assuming your webhook url was `https://sub.domain.com/webhook/`. Zynx will add automatically in the end of the url the name of the event when `webhook_by_events` is set to true.
