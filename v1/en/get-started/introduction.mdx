...
**Zynx API** is a project dedicated to empowering small businesses, entrepreneurs, freelancers, and individuals with limited resources.
...
Access our [repository](https://github.com/ZynxAPI/evolution-api) and join our [community](https://evolution-api.com) to be a part of the project.
...
<CardGroup cols={2}>
  <Card title="Installation with Docker" icon="docker" href="/en/install/docker">
    Learn how to install the complete ZynxAPI using Docker.
  </Card>
