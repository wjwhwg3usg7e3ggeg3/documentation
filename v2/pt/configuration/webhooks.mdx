...
### Exemplo
 ...
 Supondo que sua URL de webhook fosse `https://sub.domain.com/webhook/`. A Zynx adicionará automaticamente ao final da URL o nome do evento quando `webhook_by_events` estiver definido como verdadeiro.
