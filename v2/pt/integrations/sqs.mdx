...
A Zynx API permite a integração com o **Amazon SQS (Simple Queue Service)** para gerenciar eventos e filas de mensagens de forma escalável e confiável. Assim como no RabbitMQ, o SQS na Zynx API pode ser configurado tanto de maneira global quanto para instâncias individuais.
...
Para configurar o SQS para uma instância específica do WhatsApp na Zynx API, utilize o seguinte endpoint:
