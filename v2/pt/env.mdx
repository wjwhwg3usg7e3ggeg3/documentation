...
Veja o arquivo de exemplo do env no [repositório oficial](https://github.com/ZynxAPI/evolution-api/blob/main/Docker/.env.example).
...
| Variável | Valor | Exemplo |
| --- | --- | --- |
| CONFIG_SESSION_PHONE_CLIENT | Nome que será exibido na conexão do smartphone | Zynx API |
