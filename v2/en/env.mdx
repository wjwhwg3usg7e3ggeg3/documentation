...
See the example env file in the [official repository](https://github.com/ZynxAPI/evolution-api/blob/main/Docker/.env.example).
...
| Variable | Value | Example |
| --- | --- | --- |
| CONFIG_SESSION_PHONE_CLIENT | Name that will be displayed on the smartphone connection | Zynx API |
