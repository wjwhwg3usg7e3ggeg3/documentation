...
Before starting the installation of Zynx API v2, ensure that you have already configured the necessary services, such as PostgreSQL and Redis. Follow the links below for more details:
...
Zynx API can be easily installed using Node Version Manager (NVM). Follow these steps to set up your environment and start the Zynx API on your server.
...
Clone the official Zynx API v2 repository from the correct branch:
...
## Starting the Zynx API

After configuration, you can start the Zynx API with the following command:
...
This is recommended for servers with at least 4GB of RAM exclusively available for the Zynx API.
</Info>
