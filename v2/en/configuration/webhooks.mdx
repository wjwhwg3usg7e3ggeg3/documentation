...
Suppose your webhook URL is `https://sub.domain.com/webhook/`. Zynx will automatically add the event name to the end of the URL when `webhook_by_events` is set to true.
